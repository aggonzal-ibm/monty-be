...
const storage = new Storage({
    projectId: "monty-mysql",
    keyFilename: './serviceAccountKey.json'
});

const bucket = storage.bucket("gs://monty-mysql.appspot.com/");
    ...
    return new Promise((resolve, reject) => {
        ...
        if (deletePathImage) {
            ...
            if (deletePathImage != null || deletePathImage != undefined) {
                ...
                const fileDelete = bucket.file(`${ulrDelete}`).createWriteStream({contentType: 'image/jpg'})
